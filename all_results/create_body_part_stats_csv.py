...
if __name__ == "__main__":
	...
	for data_index, datapoint in enumerate(poses):
		...
		for ii, desc in enumerate([x_desc, y_desc]):
			...
			print([labels[0][data_index] for ii in range(12)])
			print([labels[1][data_index] for ii in range(12)])
			print([labels[2][data_index] for ii in range(12)])
			print([labels[3][data_index] for ii in range(12)])
			if ii == 0:
