CUDA_VISIBLE_DEVICES=2 python train_cnn.py -num_folds 8 -emotion 0 -input deltas  -keypoints full -epochs 100  -batchsize 20 -cuda -l2 0.001 > outs/anger_full.out &
...
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 2 -input deltas -keypoints full-head -epochs 100 -batchsize 20 -cuda -l2 0.001 > outs/sadness_full_head.out &
...
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 3 -input deltas -keypoints full -epochs 100  -batchsize 20 -cuda -l2 0.001 > outs/surprise_full.out &
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 3 -input deltas -keypoints full-hh -epochs 100 -batchsize 20 -cuda -l2 0.001 > outs/surprise_full_hh.out &
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 3 -input deltas -keypoints full-head -epochs 100 -batchsize 20 -cuda -l2 0.001 > outs/surprise_full_head.out &
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 3 -input deltas -keypoints head -epochs 100 -batchsize 20 -cuda -l2 0.001 > outs/surprise_head.out &
CUDA_VISIBLE_DEVICES=3 python train_cnn.py -num_folds 8 -emotion 3 -input deltas -keypoints hands -epochs 100 -batchsize 20 -cuda -l2 0.001 > outs/surprise_hands.out &
